...
I'm excited to announce that *Data Science in Education Using R* is now available for pre-order on [Routledge](https://www.routledge.com/search?kw=data+science+in+education+using+R) and [Amazon](https://www.amazon.com/s?k=data+science+in+education+using+r&crid=3VV9C2C3NGGMY&sprefix=data+science+in+education%2Caps%2C204&ref=nb_sb_ss_i_1_25)! The print version will be available from Routledge in October 2020. 
