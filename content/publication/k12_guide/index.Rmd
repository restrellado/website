---
title: 'The K-12 Educator’s Data Guidebook: Reimagining Practical Data Use in Schools (Available 2021)'
author: 'Ryan A. Estrellado'
date: '2020-10-03'
slug: k-12-educators-data-guidebook
tags: [education]
authors: ["Estrellado, R. A."]
publication_types:
  - '0'
featured: no
image:
  ...
  preview_only: no
---
I'm excited to be working with Routledge again for my next book, *The K-12 Educator's Data Guidebook: Reimagining Practical Data Use in Schools*. This is a project I've been wanting to do for a while now. I want to write an easy-to-use reference that everyday educators keep in their work bag as they discover how they want to use data to serve their students better. 
